...
public class TextPaneDemo extends javax.swing.JFrame {
    ...
    public TextPaneDemo() {
        ...
        try {
            this.jTextPane1.getDocument().insertString(0, "Welcome from Java",OPERATOR);
        } catch (BadLocationException ex) {
            Logger.getLogger(TextPaneDemo.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TextPaneDemo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
